...
def login():
    ...
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form:
        ...
        cursor.execute(f"SELECT * FROM account WHERE login='{username}' and password='{password}' ")
...
def register():
    ...
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form:
        ...
        cursor = mysql.connection.cursor()
        cursor.execute('SELECT * FROM account WHERE login = %s', (username,))
        account = cursor.fetchone()
        ...
        #     msg = 'Invalid email address!'
            ...
            cursor.execute(f'''INSERT INTO `account` (`login`, `password`) VALUES ('{username}', '{password}') ''')
